...
function ClientReview () {
  ...
  return (
    <section  className="lg:h-auto h-[25rem] lg:mb-0 mb-10 relative w-full">
      ...
      <div className="lg:px-[6.22vw] px-4 flex items-center justify-center flex-col w-full bg-white  backdrop-filter  backdrop-blur-sm bg-opacity-10 animate-fade absolute top-1/2 -translate-y-1/2">
        <div className="flex flex-col items-center justify-center lg:rounded-none rounded-lg lg:border-none border border-[#372b25]">
